...
const Hero = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Significantly reduced mouse movement effect - now 10x less responsive
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        {/* Decorative divider with reduced opacity */}
        <div className="w-40 h-5 mx-auto my-4 opacity-40 animate-fade-in" style={{animationDelay: "0.5s"}}>
        ...
        {/* Removed magical sparkles for stability */}
      </div>
      ...
      {/* Static bottom wave with reduced opacity */}
