...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-xl bg-gradient-to-r from-background/80 via-secondary/20 to-background/80 p-2 text-muted-foreground shadow-inner border border-primary/20 backdrop-blur-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ...
    className={cn(
      ...
      "before:absolute before:-top-2 before:left-1/2 before:-translate-x-1/2 before:w-8 before:h-8 before:bg-contain before:bg-no-repeat before:bg-[url('data:image/svg+xml;base64,')] before:opacity-0 data-[state=active]:before:opacity-80 before:transition-opacity before:duration-300",
      "after:absolute after:inset-0 after:bg-gradient-to-r after:from-transparent after:via-nature-leaf/5 after:to-transparent after:opacity-0 data-[state=active]:after:opacity-30 after:transition-opacity after:duration-500 after:rounded-xl",
      className
    )}
    {...props}
  />
